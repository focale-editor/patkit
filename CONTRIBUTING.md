# Contributing to PatKit

Thanks for helping improve PatKit. Bug reports, focused fixes, documentation improvements, and well-scoped features are welcome.
...
- Search [existing issues](https://github.com/focale-editor/patkit/issues) before opening a new one.
...
PatKit follows the SDK constraint in [`pubspec.yaml`](pubspec.yaml). Install a compatible stable Dart SDK, fork the repository, and run:

```sh
git clone https://github.com/YOUR_ACCOUNT/patkit.git
cd patkit
dart pub get
```
